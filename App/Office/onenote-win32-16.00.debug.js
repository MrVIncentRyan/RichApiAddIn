...
(function (OneNote) {
	...
	var OneNoteOM=(function (_super) {
		__extends(OneNoteOM, _super);
		function OneNoteOM() {
			_super.apply(this, arguments);
		}
		Object.defineProperty(OneNoteOM.prototype, "notebooks", {
			get: function () {
				if (!this.m_notebooks) {
		...
		OneNoteOM.prototype.getCurrentNotebook=function () {
			return new OneNote.Notebook(this.context, _createMethodObjectPath(this.context, this, "GetCurrentNotebook", 1 , [], false, false));
		};
		OneNoteOM.prototype.getCurrentPage=function () {
			return new OneNote.Page(this.context, _createMethodObjectPath(this.context, this, "GetCurrentPage", 1 , [], false, false));
		};
		OneNoteOM.prototype.getCurrentSection=function () {
			return new OneNote.Section(this.context, _createMethodObjectPath(this.context, this, "GetCurrentSection", 1 , [], false, false));
		};
		OneNoteOM.prototype.getNotebookById=function (id) {
			return new OneNote.Notebook(this.context, _createMethodObjectPath(this.context, this, "GetNotebookById", 1 , [id], false, false));
		};
		OneNoteOM.prototype.getPageById=function (id) {
			return new OneNote.Page(this.context, _createMethodObjectPath(this.context, this, "GetPageById", 1 , [id], false, false));
		};
		OneNoteOM.prototype.getSectionById=function (id) {
			return new OneNote.Section(this.context, _createMethodObjectPath(this.context, this, "GetSectionById", 1 , [id], false, false));
		};
		OneNoteOM.prototype.getSectionGroupById=function (id) {
		...
		OneNoteOM.prototype._GetObjectByReferenceId=function (referenceId) {
		...
		OneNoteOM.prototype._GetObjectTypeNameByReferenceId=function (referenceId) {
			var action=_createMethodAction(this.context, this, "_GetObjectTypeNameByReferenceId", 1 , [referenceId]);
			var ret=new OfficeExtension.ClientResult();
			_addActionResultHandler(this, action, ret);
			return ret;
		};
		OneNoteOM.prototype._RemoveAllReferences=function () {
			_createMethodAction(this.context, this, "_RemoveAllReferences", 1 , []);
		};
		OneNoteOM.prototype._RemoveReference=function (referenceId) {
			_createMethodAction(this.context, this, "_RemoveReference", 1 , [referenceId]);
		};
		OneNoteOM.prototype._handleResult=function (value) {
		...
		OneNoteOM.prototype.load=function (option) {
			_load(this, option);
			return this;
		};
		return OneNoteOM;
	})(OfficeExtension.ClientObject);
	OneNote.OneNoteOM=OneNoteOM;
	var Notebook=(function (_super) {
		...
		Notebook.prototype.getChildSectionGroups=function () {
			return new OneNote.SectionGroupCollection(this.context, _createMethodObjectPath(this.context, this, "GetChildSectionGroups", 1 , [], true, false));
		};
		Notebook.prototype.getChildSections=function (recursive) {
			return new OneNote.SectionCollection(this.context, _createMethodObjectPath(this.context, this, "GetChildSections", 1 , [recursive], true, false));
		};
	...
	var NotebookCollection=(function (_super) {
		...
		NotebookCollection.prototype.getById=function (id) {
			return new OneNote.Notebook(this.context, _createMethodObjectPath(this.context, this, "GetById", 1 , [id], false, false));
		};
	...
	var SectionGroup=(function (_super) {
		...
		Object.defineProperty(SectionGroup.prototype, "parentNotebook", {
			get: function () {
				if (!this.m_parentNotebook) {
					this.m_parentNotebook=new OneNote.Notebook(this.context, _createPropertyObjectPath(this.context, this, "ParentNotebook", false, false));
				}
				return this.m_parentNotebook;
			},
			enumerable: true,
			configurable: true
		});
		...
		SectionGroup.prototype.getChildSectionGroups=function () {
			return new OneNote.SectionGroupCollection(this.context, _createMethodObjectPath(this.context, this, "GetChildSectionGroups", 1 , [], true, false));
		};
		SectionGroup.prototype.getChildSections=function (recursive) {
			return new OneNote.SectionCollection(this.context, _createMethodObjectPath(this.context, this, "GetChildSections", 1 , [recursive], true, false));
		};
		...
		SectionGroup.prototype._handleResult=function (value) {
			...
			_handleNavigationPropertyResults(this, obj, ["parentNotebook", "ParentNotebook", "parentSectionGroup", "ParentSectionGroup"]);
		};
	...
	var SectionGroupCollection=(function (_super) {
		...
		SectionGroupCollection.prototype.getById=function (id) {
			return new OneNote.SectionGroup(this.context, _createMethodObjectPath(this.context, this, "GetById", 1 , [id], false, false));
		};
	...
	var Section=(function (_super) {
		...
		Object.defineProperty(Section.prototype, "parentNotebook", {
			get: function () {
				if (!this.m_parentNotebook) {
					this.m_parentNotebook=new OneNote.Notebook(this.context, _createPropertyObjectPath(this.context, this, "ParentNotebook", false, false));
				}
		...
		Section.prototype.addPage=function (location, title) {
			return new OneNote.Page(this.context, _createMethodObjectPath(this.context, this, "AddPage", 0 , [location, title], false, true));
		};
	...
	var SectionCollection=(function (_super) {
		...
		SectionCollection.prototype.getById=function (id) {
			return new OneNote.Section(this.context, _createMethodObjectPath(this.context, this, "GetById", 1 , [id], false, false));
		};
	...
	var Position=(function (_super) {
		...
		Object.defineProperty(Position.prototype, "x", {
			get: function () {
				_throwIfNotLoaded("x", this.m_x, "Position");
				return this.m_x;
			},
			set: function (value) {
				this.m_x=value;
				_createSetPropertyAction(this.context, this, "X", value);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(Position.prototype, "y", {
			get: function () {
				_throwIfNotLoaded("y", this.m_y, "Position");
				return this.m_y;
			},
			set: function (value) {
				this.m_y=value;
				_createSetPropertyAction(this.context, this, "Y", value);
			},
			enumerable: true,
			configurable: true
		});
		Position.prototype._handleResult=function (value) {
			...
			var obj=value;
			_fixObjectPathIfNecessary(this, obj);
			if (!_isUndefined(obj["X"])) {
				this.m_x=obj["X"];
			}
			if (!_isUndefined(obj["Y"])) {
				this.m_y=obj["Y"];
			}
		};
	...
	var Page=(function (_super) {
		...
		Object.defineProperty(Page.prototype, "parent", {
			get: function () {
				if (!this.m_parent) {
					this.m_parent=new OneNote.Section(this.context, _createPropertyObjectPath(this.context, this, "Parent", false, false));
				}
		...
		Page.prototype.addImageFromBase64=function (xPosition, yPosition, base64EncodedImage) {
			return new OneNote.Image(this.context, _createMethodObjectPath(this.context, this, "AddImageFromBase64", 0 , [xPosition, yPosition, base64EncodedImage], false, true));
		};
		Page.prototype.addOutline=function (xPosition, yPosition, html) {
			return new OneNote.Outline(this.context, _createMethodObjectPath(this.context, this, "AddOutline", 0 , [xPosition, yPosition, html], false, true));
		};
		Page.prototype.changeTitle=function (title) {
			_createMethodAction(this.context, this, "ChangeTitle", 0 , [title]);
		};
		...
		Page.prototype.setPageLevel=function (level) {
			_createMethodAction(this.context, this, "SetPageLevel", 0 , [level]);
		};
		...
		Page.prototype._handleResult=function (value) {
			...
			_handleNavigationPropertyResults(this, obj, ["parent", "Parent"]);
		};
	...
	var PageCollection=(function (_super) {
		...
		PageCollection.prototype.getById=function (id) {
			return new OneNote.Page(this.context, _createMethodObjectPath(this.context, this, "GetById", 1 , [id], false, false));
		};
	...
	var PageContent=(function (_super) {
		...
		Object.defineProperty(PageContent.prototype, "parent", {
			get: function () {
				if (!this.m_parent) {
					this.m_parent=new OneNote.Page(this.context, _createPropertyObjectPath(this.context, this, "Parent", false, false));
				}
				return this.m_parent;
			},
			enumerable: true,
		...
		Object.defineProperty(PageContent.prototype, "xposition", {
			get: function () {
				_throwIfNotLoaded("xposition", this.m_xposition, "PageContent");
				return this.m_xposition;
			},
			set: function (value) {
				this.m_xposition=value;
				_createSetPropertyAction(this.context, this, "XPosition", value);
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(PageContent.prototype, "yposition", {
			get: function () {
				_throwIfNotLoaded("yposition", this.m_yposition, "PageContent");
				return this.m_yposition;
			},
			set: function (value) {
				this.m_yposition=value;
				_createSetPropertyAction(this.context, this, "YPosition", value);
			},
			enumerable: true,
			configurable: true
		});
		...
		PageContent.prototype.getImage=function () {
			return new OneNote.Image(this.context, _createMethodObjectPath(this.context, this, "GetImage", 1 , [], false, false));
		};
		PageContent.prototype.getOutline=function () {
			return new OneNote.Outline(this.context, _createMethodObjectPath(this.context, this, "GetOutline", 1 , [], false, false));
		};
		...
		PageContent.prototype._handleResult=function (value) {
			...
			if (!_isUndefined(obj["XPosition"])) {
				this.m_xposition=obj["XPosition"];
			}
			if (!_isUndefined(obj["YPosition"])) {
				this.m_yposition=obj["YPosition"];
			}
			if (!_isUndefined(obj["_ReferenceId"])) {
				this.m__ReferenceId=obj["_ReferenceId"];
			}
	...
	var PageContentCollection=(function (_super) {
		...
		PageContentCollection.prototype.getById=function (id) {
			return new OneNote.PageContent(this.context, _createMethodObjectPath(this.context, this, "GetById", 1 , [id], false, false));
		};
	...
	var Outline=(function (_super) {
		...
		Object.defineProperty(Outline.prototype, "parent", {
			get: function () {
				if (!this.m_parent) {
					this.m_parent=new OneNote.PageContent(this.context, _createPropertyObjectPath(this.context, this, "Parent", false, false));
				}
				return this.m_parent;
			},
			enumerable: true,
		...
		Outline.prototype.append=function (location, html) {
			_createMethodAction(this.context, this, "Append", 0 , [location, html]);
		};
		...
		Outline.prototype._handleResult=function (value) {
			...
			_handleNavigationPropertyResults(this, obj, ["paragraphs", "Paragraphs", "parent", "Parent"]);
		};
	...
	var Paragraph=(function (_super) {
		...
		Object.defineProperty(Paragraph.prototype, "parentOutline", {
			get: function () {
				if (!this.m_parentOutline) {
					this.m_parentOutline=new OneNote.Outline(this.context, _createPropertyObjectPath(this.context, this, "ParentOutline", false, false));
				}
				return this.m_parentOutline;
			},
			enumerable: true,
			configurable: true
		});
		...
		Paragraph.prototype.getImage=function () {
			return new OneNote.Image(this.context, _createMethodObjectPath(this.context, this, "GetImage", 1 , [], false, false));
		};
		Paragraph.prototype.getRichText=function () {
			return new OneNote.RichText(this.context, _createMethodObjectPath(this.context, this, "GetRichText", 1 , [], false, false));
		};
		...
		Paragraph.prototype._handleResult=function (value) {
			...
			_handleNavigationPropertyResults(this, obj, ["parentOutline", "ParentOutline", "parentParagraph", "ParentParagraph", "subParagraphs", "SubParagraphs"]);
		};
	...
	var ParagraphCollection=(function (_super) {
		...
		ParagraphCollection.prototype.getById=function (id) {
			return new OneNote.Paragraph(this.context, _createMethodObjectPath(this.context, this, "GetById", 1 , [id], false, false));
		};
	...
	var RichText=(function (_super) {
		...
		Object.defineProperty(RichText.prototype, "parent", {
			get: function () {
				if (!this.m_parent) {
					this.m_parent=new OneNote.Paragraph(this.context, _createPropertyObjectPath(this.context, this, "Parent", false, false));
				}
				return this.m_parent;
			},
			enumerable: true,
	...
	var Image=(function (_super) {
		...
		Object.defineProperty(Image.prototype, "parent", {
			get: function () {
				if (!this.m_parent) {
					this.m_parent=new OneNote.Paragraph(this.context, _createPropertyObjectPath(this.context, this, "Parent", false, false));
				}
		...
		Image.prototype.getBase64ImageSrc=function () {
	...
	(function (AppendLocation) {
		AppendLocation.begin="Begin";
		AppendLocation.end="End";
	})(AppendLocation=OneNote.AppendLocation || (OneNote.AppendLocation={}));
	var Alignment;
	(function (Alignment) {
		Alignment.left="Left";
...
(function (OneNote) {
	var RequestContext=(function (_super) {
		...
		function RequestContext(url) {
			...
			this.m_onenote=new OneNote.OneNoteOM(this, OfficeExtension.ObjectPathFactory.createGlobalObjectObjectPath(this));
			this._rootObject=this.m_onenote;
		}
		Object.defineProperty(RequestContext.prototype, "Notebooks", {
			get: function () {
				return this.m_onenote.notebooks;
			},
			enumerable: true,
			configurable: true
		});
		RequestContext.prototype.GetPageById=function (id) {
			return this.m_onenote.getPageById(id);
		};
		RequestContext.prototype.GetSectionById=function (id) {
			return this.m_onenote.getSectionById(id);
		};
		RequestContext.prototype.GetNotebookById=function (id) {
			return this.m_onenote.getNotebookById(id);
		};
		Object.defineProperty(RequestContext.prototype, "CurrentNotebook", {
			get: function () {
				return this.m_onenote.getCurrentNotebook();
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(RequestContext.prototype, "CurrentSection", {
			get: function () {
				return this.m_onenote.getCurrentSection();
			},
			enumerable: true,
			configurable: true
		});
		Object.defineProperty(RequestContext.prototype, "CurrentPage", {
			get: function () {
				return this.m_onenote.getCurrentPage();
			},
			enumerable: true,
			configurable: true
		});

...
(function (OsfRuntimeWinRT) {
    ...
    var OsfControlWinRT = (function (_super) {
        ...
        OsfControlWinRT.prototype._serializeObjectToString = function (response) {
        ...
        OsfControlWinRT.prototype._activate = function (frame, iframeUrl) {
            ...
            var hostInfo = this._contextActivationMgr.hostType + "|" + this._contextActivationMgr.hostPlatform + "|" + this._contextActivationMgr.hostSpecificFileVersion;
            var newUrl = this._addHostInfoAsQueryParam(iframeUrl, hostInfo);
            var xdmInfo = this._conversationId + "|" + this.id + "|" + window.location.href;
            ...
            frame.setAttribute("name", this._serializeObjectToString(frameName));
...
var OsfRuntimeWinRTAgavito;
(function (OsfRuntimeWinRTAgavito) {
    var ContextActivationManagerWinRTAgavito = (function (_super) {
        __extends(ContextActivationManagerWinRTAgavito, _super);
        function ContextActivationManagerWinRTAgavito(contextActivationParameters) {
            _super.call(this, contextActivationParameters);
            this.hostType = OSF.HostType.Agavito;
            this.hostPlatform = OSF.HostPlatform.WinRT;
            this.hostSpecificFileVersion = OSF.HostSpecificFileVersionMap["agavito"]["winrt"];
        }
        return ContextActivationManagerWinRTAgavito;
    })(OsfRuntimeWinRT.ContextActivationManagerWinRT);
    OsfRuntimeWinRTAgavito.ContextActivationManagerWinRTAgavito = ContextActivationManagerWinRTAgavito;
})(OsfRuntimeWinRTAgavito || (OsfRuntimeWinRTAgavito = {}));
var WinRTAgavitoHost;
(function (WinRTAgavitoHost) {
    function init() {
        var hostControl = new WinRTHost.HostControl(getParentHtml());
        var activationParams = new OsfRuntimeWinRT.ContextActivationParametersWinRT(16, "16", 1, "en-US", "en-US", hostControl);
        var activaitonManager = new OsfRuntimeWinRTAgavito.ContextActivationManagerWinRTAgavito(activationParams);
        var osfControlParams = new OsfRuntimeWinRT.InsertOsfControlParametersWinRT(getParentHtml(), "{34CC6799-EB37-4BB7-986D-FB8ACC07BADC}", OSF.OsfControlTarget.InContent, "http://localhost:999/ImmersiveIFramePage.html");
        activaitonManager.insertOsfControl(osfControlParams);
    }
    WinRTAgavitoHost.init = init;
    function getParentHtml() {
        return document.getElementById("appForOfficeContainerDiv");
    }
})(WinRTAgavitoHost || (WinRTAgavitoHost = {}));

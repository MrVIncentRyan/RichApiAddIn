...
(function (OsfRuntime) {
    var PolicyManager = (function () {
        function PolicyManager(contextActivationManager, registeredActions) {
            ...
            this.contextActivationManager = contextActivationManager;
            ...
            for (var actionName in registeredActions) {
                ...
                this.registeredActions[actionName] = registeredPermission;
            }
        }
        PolicyManager.prototype.checkPermissionForEmbeddingEndpoint = function (actionName, params, canWrite) {
            if (params
                && params.DdaMethod
...
(function (VisioWACRuntime) {
    ...
    VisioWACRuntime._setupFacade = _setupFacade;
    ;
})(VisioWACRuntime || (VisioWACRuntime = {}));
OSF.AppSpecificSetup._setupFacade = VisioWACRuntime._setupFacade;
//# sourceMappingURL=OsfRuntimeVisioWeb.debug.js.map
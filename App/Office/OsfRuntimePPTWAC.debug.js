...
var PPTWACRuntime;
(function (PPTWACRuntime) {
    var PPTFacade = (function () {
        function PPTFacade(_wnd, _hostControl) {
            this._wnd = _wnd;
            this._hostControl = _hostControl;
    ...
    function _setupFacade(hostControl, contextActivationManager, serviceEndPoint) {
        var pptFacade = new PPTFacade(window, hostControl);
        contextActivationManager._appsActivatedStatus = {};
        contextActivationManager.setActivationCompletedStatus = function (appInstanceId, status) {
            contextActivationManager._appsActivatedStatus[appInstanceId] = status;
        };
        contextActivationManager.getActivationCompletedStatus = function (appInstanceId) {
            if (contextActivationManager._appsActivatedStatus[appInstanceId]) {
                return contextActivationManager._appsActivatedStatus[appInstanceId];
            }
            else {
                return false;
            }
        };
        pptFacade.serviceEndpoint = serviceEndPoint;
        var registeredActions = {
            ...
            'officeThemeChanged': OSF.OsfControlPermission.Restricted,
            'activationCompleted': OSF.OsfControlPermission.Restricted,
            'getActivationCompletedStatus': OSF.OsfControlPermission.Restricted,
        ...
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidNavigateToMethod] = OSF.OsfControlPermission.Restricted;
        ...
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetOfficeThemeMethod] = OSF.OsfControlPermission.Restricted;
        ...
        var policyManager = new PPTWACPolicyManager(contextActivationManager, registeredActions);
        serviceEndPoint.setPolicyManager(policyManager);
        serviceEndPoint.registerMethod("executeMethod", pptFacade.executeMethod, Microsoft.Office.Common.InvokeType.async, false);
        serviceEndPoint.registerEventEx("settingsChanged", pptFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, pptFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerEventEx("activeViewChanged", pptFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, pptFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerEventEx("documentThemeChanged", pptFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, pptFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerEventEx("documentSelectionChanged", pptFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, pptFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerEventEx("officeThemeChanged", pptFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, pptFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerEventEx("activationCompleted", pptFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, pptFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        ...
        serviceEndPoint.registerEventEx("dialogMessageReceived", pptFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, pptFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerMethod("getActivationCompletedStatus", contextActivationManager.getActivationCompletedStatus, Microsoft.Office.Common.InvokeType.sync, false);
        ...
        contextActivationManager._hostType = OSF.HostType.PowerPoint;
        contextActivationManager._hostPlatform = OSF.HostPlatform.Web;
        contextActivationManager._hostSpecificFileVersion = OSF.HostSpecificFileVersionMap["powerpoint"]["web"];
        OSF.OsfControl.prototype.getTrustNoPrompt = function OSF_OsfControl$getTrustNoPrompt() {
            if (contextActivationManager.getClientMode() == OSF.ClientMode.ReadWrite) {
                return false;
            }
            else {
                return (this._permission == OSF.OsfControlPermission.Restricted);
            }
        };
        var supportedCapabilities = [OSF.Capability.Presentation];
        var supportedHosts = [OSF.Capability.Presentation];
        var supportedSets = [{
    ...
    PPTWACRuntime._setupFacade = _setupFacade;
    var PPTWACPolicyManager = (function () {
        function PPTWACPolicyManager(contextActivationManager, registeredActions) {
            var e = Function._validateParams(arguments, [
                {
        ...
        PPTWACPolicyManager.prototype.checkPermission = function (conversationID, actionName, params) {
        ...
        PPTWACPolicyManager.prototype.validatePermissionInput = function (permission) {
        ...
        return PPTWACPolicyManager;
    })();
    PPTWACRuntime.PPTWACPolicyManager = PPTWACPolicyManager;
})(PPTWACRuntime || (PPTWACRuntime = {}));
OSF.AppSpecificSetup._setupFacade = PPTWACRuntime._setupFacade;

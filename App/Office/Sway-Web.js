/* Sway Applications specific API library */
...
var OSFSwayWeb;
(function (OSFSwayWeb) {
    var SwayDocument = (function () {
        function SwayDocument(officeAppContext, settings) {
            var bindingFacade = new OSF.DDA.BindingFacade(this);
            OSF.DDA.SwayDocument.uber.constructor.call(this, officeAppContext, bindingFacade, settings);
            OSF.DDA.DispIdHost.addAsyncMethods(this, [
    ...
    OSFSwayWeb.SwayDocument = SwayDocument;
})(OSFSwayWeb || (OSFSwayWeb = {}));
OSF.DDA.SwayDocument = OSFSwayWeb.SwayDocument;
OSF.OUtil.extend(OSF.DDA.SwayDocument, OSF.DDA.JsomDocument);
...
OSF.InitializationHelper.prototype.loadAppSpecificScriptAndCreateOM = function OSF_InitializationHelper$loadAppSpecificScriptAndCreateOM(appContext, appReady, basePath) {
    ...
    appContext.doc = new OSF.DDA.SwayDocument(appContext, this._initializeSettings(appContext, true));
    appReady();
};

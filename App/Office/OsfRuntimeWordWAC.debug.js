...
(function (Telemetry) {
    ...
    var RuntimeTelemetryHelper = (function () {
        ...
        RuntimeTelemetryHelper.LogExceptionTag = function (message, exception, appCorrelationId, tagId) {
            ...
            Logger.SendULSTraceTag(RuntimeTelemetryHelper.category, ULSTraceLevel.warning, constructedMessage, 0x005c8161);
        };
        RuntimeTelemetryHelper.LogCommonMessage = function (message, tagId) {
            var constructedMessage = message;
            constructedMessage += OSF.OUtil.formatString(" SourceTag: {0}.", tagId);
            Logger.SendULSTraceTag(RuntimeTelemetryHelper.category, ULSTraceLevel.info, constructedMessage, 0x0109b64a);
        };
...
OSF.Constants = {
    FileVersion: "16.0.6807.3002",
    ThreePartsFileVersion: "16.0.6807",
...
OSF.OsfControl.prototype = {
    activate: function OSF_OsfControl$activate(context) {
        try {
            Telemetry.AppLoadTimeHelper.ActivationStart(this._telemetryContext, this._sqmDWords[0], this._sqmDWords[1], this.getCorrelationId(), this._id);
            this._controlFocus = false;
            ...
            if (this._status !== OSF.OsfControlStatus.Activated) {
                ...
                if (this._contextActivationMgr._autoTrusted && !sandboxSupported && !ignoreSandBox) {
                    ...
                    this._errorcode = OSF.ErrorStatusCodes.WAC_HTML5IframeSandboxNotSupport;
                    ...
                    if (this._contextActivationMgr.isExternalMarketplaceAllowed() && this._contextActivationMgr._doesUrlHaveSupportedProtocol(this._contextActivationMgr._osfOmexBaseUrl)) {
                        ...
                        var onGetAuthNStatusCompleted = function (asyncResult) {
                            if (asyncResult.statusCode === OSF.ProxyCallStatusCode.Succeeded && asyncResult.value) {
                                ...
                                Telemetry.RuntimeTelemetryHelper.LogExceptionTag("OMEX_getAuthNStatus failed:" + OSF.OUtil.serializeOMEXResponseErrorMessage(asyncResult), null, null, 0x010c5398);
    ...
    onForceGetVirtualOsfControlManifestCompleted: function OSF_OsfControl$onForceGetVirtualOsfControlManifestCompleted(asyncResult) {
        ...
        if (asyncResult.statusCode === OSF.ProxyCallStatusCode.Succeeded && asyncResult.value) {
            ...
            this._errorcode = OSF.ErrorStatusCodes.E_MANIFEST_SERVER_UNAVAILABLE;
        }
    ...
    forceGetVirtualOsfControlManifest: function OSF_OsfControl$forceGetVirtualOsfControlManifest() {
        ...
        if (this._dataProvider != null) {
            this._dataProvider.getManifestAsync(context, this.onForceGetVirtualOsfControlManifestCompleted);
        }
        else {
    ...
    getErrorcode: function OSF_OsfControl$getErrorcode() {
        return this._errorcode;
    },
    ...
    _onGetOmexEntitlementsCompleted: function OSF_OsfControl$_onGetOmexEntitlementsCompleted(asyncResult) {
        if (asyncResult.statusCode === OSF.ProxyCallStatusCode.Succeeded && asyncResult.value) {
            ...
            Telemetry.RuntimeTelemetryHelper.LogExceptionTag("getOmexEntilements failed:" + OSF.OUtil.serializeOMEXResponseErrorMessage(asyncResult), null, null, 0x010c539a);
            this._showActivationError(OSF.OsfControlStatus.ActivationFailed, Strings.OsfRuntime.L_AgaveServerConnectionFailed_ERR, Strings.OsfRuntime.L_RetryButton_TXT, Function.createDelegate(this, this._refresh), null, null, null, null, OSF.ErrorStatusCodes.E_MANIFEST_SERVER_UNAVAILABLE);
        }
    },
    _onGetOmexKilledAppsCompleted: function OSF_OsfControl$_onGetOmexKilledAppsCompleted(asyncResult) {
        if (asyncResult.statusCode === OSF.ProxyCallStatusCode.Succeeded && asyncResult.value) {
            ...
            Telemetry.RuntimeTelemetryHelper.LogExceptionTag("getOmexKilledApps failed:" + OSF.OUtil.serializeOMEXResponseErrorMessage(asyncResult), null, null, 0x010c539b);
        }
    },
    _onGetOmexAppStateCompleted: function OSF_OsfControl$_onGetOmexAppStateCompleted(asyncResult) {
        if (asyncResult.statusCode === OSF.ProxyCallStatusCode.Succeeded && asyncResult.value) {
            ...
            Telemetry.RuntimeTelemetryHelper.LogExceptionTag("getOmexAppState failed:" + OSF.OUtil.serializeOMEXResponseErrorMessage(asyncResult), null, null, 0x010c539c);
        }
    ...
    _onGetOmexManifestAndETokenCompleted: function OSF_OsfControl$_onGetOmexManifestAndETokenCompleted(asyncResult) {
        if (asyncResult.statusCode === OSF.ProxyCallStatusCode.Succeeded && asyncResult.value) {
            ...
            Telemetry.RuntimeTelemetryHelper.LogExceptionTag("GetOmexManifestAndEToken failed:" + OSF.OUtil.serializeOMEXResponseErrorMessage(asyncResult), null, null, 0x010c539d);
            this._showActivationError(OSF.OsfControlStatus.ActivationFailed, Strings.OsfRuntime.L_AgaveServerConnectionFailed_ERR, Strings.OsfRuntime.L_RetryButton_TXT, Function.createDelegate(this, this._refresh), null, null, null, null, OSF.ErrorStatusCodes.E_MANIFEST_SERVER_UNAVAILABLE);
        }
    },
                    ...
                    if (osfControl._retryLoadingNum === 2) {
                        ...
                        switch (osfControl._pageStatus) {
                            ...
                            case OSF.OsfControlPageStatus.FailedPermissionCheck:
                                ...
                                break;
                            case OSF.OsfControlPageStatus.Failed:
    ...
    _onGetManifestCompleted: function OSF_OsfControl$_onGetManifestCompleted(asyncResult) {
        if (asyncResult.statusCode === OSF.ProxyCallStatusCode.Succeeded && asyncResult.value) {
                        ...
                        if (currentStoreType == OSF.StoreType.OMEX && _omexDataProvider.GetCustomerId() != "0") {
                            ...
                            var onGetOmexManifestAndETokenCompleted = function (asyncResult) {
                                if (asyncResult.statusCode === OSF.ProxyCallStatusCode.Succeeded && asyncResult.value) {
                                    ...
                                    Telemetry.RuntimeTelemetryHelper.LogExceptionTag("Manual active getOmexManifestAndEToken failed:" + OSF.OUtil.serializeOMEXResponseErrorMessage(asyncResult), null, null, 0x010c539e);
                                }
            ...
            Telemetry.RuntimeTelemetryHelper.LogExceptionTag("GetManifest failed:" + OSF.OUtil.serializeOMEXResponseErrorMessage(asyncResult), null, null, 0x010c539f);
    ...
    _showTrustError: function OSF_OsfControl$_showTrustError(displayName, providerName, storeType, onManualActivate) {
        ...
        this._errorcode = OSF.ErrorStatusCodes.E_TRUSTCENTER_MOE_UNACTIVATED;
        this._contextActivationMgr.displayNotification({
            "id": this._id,
    ...
    _activate: function OSF_OsfControl$_activate(frame, iframeUrl) {
        ...
        newUrl = OSF.OUtil.addXdmInfoAsHash(newUrl, this._conversationId + "|" + this._id + "|" + (hrefUrl.indexOf("$") >= 0 ? encodeURIComponent(hrefUrl) : hrefUrl));
...
OSF.ContextActivationManager = function OSF_ContextActivationManager(params) {
    ...
    Telemetry.RuntimeTelemetryHelper.LogCommonMessage("_contextMgrCorrelationId :" + this._contextMgrCorrelationId, 0);
    this._hostType = null;
    ...
    var onClickInstallOsfControl = function (params, callback) {
        ...
        if (requestMessage && (param = requestMessage._data)) {
            ...
            if (osfControlInstanceId && (osfControl = me.getOsfControl(osfControlInstanceId))) {
                if (exception === "Failed origin check") {
                    ...
                    osfControl._pageStatus = OSF.OsfControlPageStatus.Failed;
                }
    ...
    this._serviceEndPointInternal.registerMethod("ContextActivationManager_onClickInstallOsfControl", onClickInstallOsfControl, Microsoft.Office.Common.InvokeType.async, false);
...
OSF.ContextActivationManager.prototype = {
    ...
    displayNotification: function OSF_ContextActivationManager$displayNotification(params) {
        ...
        if (osfControl) {
            if (osfControl._isvirtualOsfControl) {
                osfControl._notificationParams = params;
    ...
    notifyAgave: function OSF_ContextActivationManager$notifyAgave(id, actionId) {
        ...
        var osfControl = this._cachedOsfControls[id];
        if (typeof osfControl != "undefined") {
            if (osfControl._pageStatus !== OSF.OsfControlPageStatus.Ready && (actionId === OSF.AgaveHostAction.CtrlF6In || actionId === OSF.AgaveHostAction.Select)) {
        ...
        if (omexProxy.isReady) {
            ...
            var onIsProxyReadyCallback = function (errorCode, response) {
                ...
                if (errorCode === 0 && response.status) {
                    ...
                    var errorInfo = OSF.OUtil.formatString("Proxy is not ready, errorCode:{0}, proxyUrl:{1}. {2}", errorCode, omexProxy.proxyUrl, OSF.OUtil.serializeOMEXResponseErrorMessage(response));
                    Telemetry.RuntimeTelemetryHelper.LogExceptionTag(errorInfo, null, null, 0x0109304c);
                    omexProxy.clientEndPoint = null;
            ...
            if (manifest) {
                ...
                var onRetrieveManifestCompleted = function (asyncResult) {
                    if (asyncResult.statusCode === OSF.ProxyCallStatusCode.Succeeded && asyncResult.value) {
                        ...
                        Telemetry.RuntimeTelemetryHelper.LogExceptionTag("getManifestAsync failed:" + OSF.OUtil.serializeOMEXResponseErrorMessage(asyncResult), null, null, 0x010c53a1);
                    }
...
(function (OsfRuntime) {
    var Throttling;
    (function (Throttling) {
        (function (ThrottleRequestStatus) {
            ThrottleRequestStatus[ThrottleRequestStatus["Allowed"] = 0] = "Allowed";
            ThrottleRequestStatus[ThrottleRequestStatus["ThrottledUnspecified"] = 10] = "ThrottledUnspecified";
            ThrottleRequestStatus[ThrottleRequestStatus["ThrottledThrottleNotInitialized"] = 11] = "ThrottledThrottleNotInitialized";
            ThrottleRequestStatus[ThrottleRequestStatus["ThrottledTooManyIncompleteRequests"] = 12] = "ThrottledTooManyIncompleteRequests";
            ThrottleRequestStatus[ThrottleRequestStatus["ThrottledRequestTokensUnavailable"] = 13] = "ThrottledRequestTokensUnavailable";
        })(Throttling.ThrottleRequestStatus || (Throttling.ThrottleRequestStatus = {}));
        var ThrottleRequestStatus = Throttling.ThrottleRequestStatus;
    })(Throttling = OsfRuntime.Throttling || (OsfRuntime.Throttling = {}));
})(OsfRuntime || (OsfRuntime = {}));
var OsfRuntime;
(function (OsfRuntime) {
    var Throttling;
    (function (Throttling) {
        var IncompleteRequestThrottle = (function () {
            function IncompleteRequestThrottle(_maxIncompleteRequestCount, _timeoutInMilliSec) {
                if (_timeoutInMilliSec === void 0) { _timeoutInMilliSec = -1; }
                this._maxIncompleteRequestCount = _maxIncompleteRequestCount;
                this._timeoutInMilliSec = _timeoutInMilliSec;
                this.reset();
            }
            IncompleteRequestThrottle.prototype.tryRequest = function (requestDelegate) {
                if (!this._shouldRequestBeAllowed()) {
                    return Throttling.ThrottleRequestStatus.ThrottledTooManyIncompleteRequests;
                }
                requestDelegate();
                return Throttling.ThrottleRequestStatus.Allowed;
            };
            IncompleteRequestThrottle.prototype.tryAsyncRequest = function (requestDelegate) {
                var _this = this;
                if (!this._shouldRequestBeAllowed()) {
                    return Throttling.ThrottleRequestStatus.ThrottledTooManyIncompleteRequests;
                }
                var requestToken = this._addRequestAndGetToken();
                requestDelegate(function () {
                    _this._removeRequestWithToken(requestToken);
                });
                return Throttling.ThrottleRequestStatus.Allowed;
            };
            IncompleteRequestThrottle.prototype.reset = function () {
                this._currentlyExecutingRequestsToTimeoutIDMapping = {};
                this._currentlyExecutingRequestCount = 0;
                this._requestToken = 0;
            };
            IncompleteRequestThrottle.prototype._shouldRequestBeAllowed = function () {
                return this._currentlyExecutingRequestCount < this._maxIncompleteRequestCount;
            };
            IncompleteRequestThrottle.prototype._addRequestAndGetToken = function () {
                var _this = this;
                var requestToken = this._requestToken;
                if (this._timeoutInMilliSec >= 0) {
                    var timeoutID = setTimeout(function () { return _this._removeRequestWithToken(requestToken); }, this._timeoutInMilliSec);
                }
                this._currentlyExecutingRequestsToTimeoutIDMapping[requestToken] = timeoutID;
                this._currentlyExecutingRequestCount++;
                this._requestToken++;
                return requestToken;
            };
            IncompleteRequestThrottle.prototype._removeRequestWithToken = function (requestToken) {
                if (!this._currentlyExecutingRequestsToTimeoutIDMapping.hasOwnProperty(requestToken.toString())) {
                    return;
                }
                var timeoutID = this._currentlyExecutingRequestsToTimeoutIDMapping[requestToken];
                delete this._currentlyExecutingRequestsToTimeoutIDMapping[requestToken];
                this._currentlyExecutingRequestCount--;
                clearTimeout(timeoutID);
            };
            return IncompleteRequestThrottle;
        })();
        Throttling.IncompleteRequestThrottle = IncompleteRequestThrottle;
    })(Throttling = OsfRuntime.Throttling || (OsfRuntime.Throttling = {}));
})(OsfRuntime || (OsfRuntime = {}));
var OsfRuntime;
(function (OsfRuntime) {
    var Throttling;
    (function (Throttling) {
        var TokenBucketThrottle = (function () {
            function TokenBucketThrottle(_bucketCapacity, _tokenFillingIntervalInMilliSec) {
                this._bucketCapacity = _bucketCapacity;
                this._tokenFillingIntervalInMilliSec = _tokenFillingIntervalInMilliSec;
                this.reset();
            }
            TokenBucketThrottle.prototype.tryRequest = function (requestDelegate) {
                return this._tryRequestInternal(requestDelegate, false);
            };
            TokenBucketThrottle.prototype.tryAsyncRequest = function (requestDelegate) {
                return this._tryRequestInternal(requestDelegate, true);
            };
            TokenBucketThrottle.prototype.reset = function () {
                this._lastCallStartedAt = 0;
                this._tokenCountAfterLastCall = this._bucketCapacity;
            };
            TokenBucketThrottle.prototype._tryRequestInternal = function (requestDelegate, isAsync) {
                var currentTime = new Date().getTime();
                var tokenCount = this._getTokenCountAtTime(currentTime);
                if (tokenCount < 1) {
                    return Throttling.ThrottleRequestStatus.ThrottledRequestTokensUnavailable;
                }
                this._lastCallStartedAt = currentTime;
                this._tokenCountAfterLastCall = tokenCount - 1;
                var onRequestComplete = isAsync ? [function () { }] : [];
                requestDelegate.apply(undefined, onRequestComplete);
                return Throttling.ThrottleRequestStatus.Allowed;
            };
            TokenBucketThrottle.prototype._getTokenCountAtTime = function (currentTime) {
                if (currentTime < this._lastCallStartedAt) {
                    return 0;
                }
                return Math.min(this._bucketCapacity, this._tokenCountAfterLastCall + (currentTime - this._lastCallStartedAt) / this._tokenFillingIntervalInMilliSec);
            };
            return TokenBucketThrottle;
        })();
        Throttling.TokenBucketThrottle = TokenBucketThrottle;
    })(Throttling = OsfRuntime.Throttling || (OsfRuntime.Throttling = {}));
})(OsfRuntime || (OsfRuntime = {}));
var OsfRuntime;
(function (OsfRuntime) {
    var Throttling;
    (function (Throttling) {
        var ThrottleFactory = (function () {
            function ThrottleFactory() {
            }
            ThrottleFactory.prototype.createIncompleteRequestThrottle = function (maxIncompleteRequests, timeoutInMilliSec) {
                return new Throttling.IncompleteRequestThrottle(maxIncompleteRequests, timeoutInMilliSec);
            };
            ThrottleFactory.prototype.createTokenBucketThrottle = function (bucketCapacity, tokenFillingIntervalInMilliSec) {
                return new Throttling.TokenBucketThrottle(bucketCapacity, tokenFillingIntervalInMilliSec);
            };
            ThrottleFactory.prototype.createChainedThrottle = function (throttles) {
                return new Throttling.ChainedThrottle(throttles);
            };
            return ThrottleFactory;
        })();
        Throttling.ThrottleFactory = ThrottleFactory;
    })(Throttling = OsfRuntime.Throttling || (OsfRuntime.Throttling = {}));
})(OsfRuntime || (OsfRuntime = {}));
var OsfRuntime;
(function (OsfRuntime) {
    var Throttling;
    (function (Throttling) {
        var ChainedThrottle = (function () {
            function ChainedThrottle(_throttles) {
                this._throttles = _throttles;
                this._throttles = _throttles || [];
            }
            ChainedThrottle.prototype.tryRequest = function (requestDelegate) {
                var numThrottles = this._throttles.length;
                if (numThrottles === 0) {
                    requestDelegate();
                    return Throttling.ThrottleRequestStatus.Allowed;
                }
                var throttleInvocationCount = 0;
                function throttleInvocation() {
                    throttleInvocationCount++;
                    if (throttleInvocationCount === numThrottles) {
                        requestDelegate();
                    }
                }
                for (var i = 0; i < numThrottles; ++i) {
                    var status = this._throttles[i].tryRequest(throttleInvocation);
                    if (status !== Throttling.ThrottleRequestStatus.Allowed) {
                        break;
                    }
                }
                return status;
            };
            ChainedThrottle.prototype.tryAsyncRequest = function (requestDelegate) {
                var numThrottles = this._throttles.length;
                if (numThrottles === 0) {
                    requestDelegate(function () { });
                    return Throttling.ThrottleRequestStatus.Allowed;
                ...
                var throttleInvocationCount = 0;
                var requestHasBeenThrottled = false;
                var throttleOnCompleteCallbacks = new Array(numThrottles);
                function processOnCompleteCallbacks() {
                    for (var i = 0; i < numThrottles; ++i) {
                        if (throttleOnCompleteCallbacks[i]) {
                            throttleOnCompleteCallbacks[i]();
                        }
                    }
                }
                function getThrottleInvocationDelegate(index) {
                    return function throttleInvocationDelegate(onComplete) {
                        if (requestHasBeenThrottled) {
                            onComplete();
                        }
                        throttleOnCompleteCallbacks[index] = onComplete;
                        throttleInvocationCount++;
                        if (throttleInvocationCount === numThrottles) {
                            requestDelegate(processOnCompleteCallbacks);
                        }
                    };
                }
                for (var i = 0; i < numThrottles; ++i) {
                    var status = this._throttles[i].tryAsyncRequest(getThrottleInvocationDelegate(i));
                    if (status !== Throttling.ThrottleRequestStatus.Allowed) {
                        requestHasBeenThrottled = true;
                        processOnCompleteCallbacks();
                        break;
                    }
                }
                return status;
            };
            ChainedThrottle.prototype.reset = function () {
                for (var i = 0, len = this._throttles.length; i < len; ++i) {
                    this._throttles[i].reset();
                }
            };
            return ChainedThrottle;
        })();
        Throttling.ChainedThrottle = ChainedThrottle;
    })(Throttling = OsfRuntime.Throttling || (OsfRuntime.Throttling = {}));
})(OsfRuntime || (OsfRuntime = {}));
OSF.DataPointNames = {
...
OSF.OUtil.setNamespace("Marshaling", OSF.DDA);
OSF.DDA.Marshaling.BindingParameterKeys = {
    Id: "BindingId",
    BindingType: "BindingType",
    ItemName: "ItemName",
    StartRow: "StartRow",
...
OSF.DDA.Marshaling.TableBindingParameterKeys = {
    TableHeaders: "TableHeaders",
    TableRows: "TableRows"
};
OSF.DDA.Marshaling.AppBindingKeys = {
    BindingId: "Name",
    BindingType: "BindingType",
    BindingProperties: 0,
...
OSF.DDA.Marshaling.TableSubsetKeys = {
    TableSubset: "subset",
    StartRow: "startRow",
    StartColumn: "startColumn",
    RowCount: "rowCount",
...
var OSF_DDA_Marshaling_BindingType;
(function (OSF_DDA_Marshaling_BindingType) {
    OSF_DDA_Marshaling_BindingType[OSF_DDA_Marshaling_BindingType["Table"] = 1] = "Table";
    OSF_DDA_Marshaling_BindingType[OSF_DDA_Marshaling_BindingType["Text"] = 2] = "Text";
    OSF_DDA_Marshaling_BindingType[OSF_DDA_Marshaling_BindingType["Matrix"] = 3] = "Matrix";
})(OSF_DDA_Marshaling_BindingType || (OSF_DDA_Marshaling_BindingType = {}));
OSF.DDA.Marshaling.BindingType = OSF_DDA_Marshaling_BindingType;
OSF.OUtil.setNamespace("Marshaling", OSF.DDA);
...
var ContextActivationManagerBuilderBase = (function () {
    function ContextActivationManagerBuilderBase(hostInfo, localeInfo) {
        this._params = {};
        this._addParams(hostInfo);
        this._addParams(localeInfo);
    }
    ContextActivationManagerBuilderBase.prototype.setHostInfo = function (hostInfo) {
        return this;
    };
    ContextActivationManagerBuilderBase.prototype.setLocaleInfo = function (localeInfo) {
        return this;
    };
    ContextActivationManagerBuilderBase.prototype.setUrlInfo = function (urlInfo) {
        this._addParams(urlInfo);
        return this;
    };
    ContextActivationManagerBuilderBase.prototype.setHostControlInfo = function (hostControlInfo) {
        this._addParams(hostControlInfo);
        return this;
    };
    ContextActivationManagerBuilderBase.prototype.setMiscellaneousActivationParameters = function (activationParameters) {
        this._addParams(activationParameters);
        return this;
    };
    ContextActivationManagerBuilderBase.prototype.setUserInfo = function (userInfo) {
        this._addParams(userInfo);
        return this;
    };
    ContextActivationManagerBuilderBase.prototype.construct = function () {
        return new OSF.ContextActivationManager(this._params);
    };
    ContextActivationManagerBuilderBase.prototype._addParams = function (params) {
    ...
    return ContextActivationManagerBuilderBase;
})();
OSF.ContextActivationManagerBuilder = ContextActivationManagerBuilderBase;
...
OSF.DDA.ErrorCodeManager = OSF.DDA.ErrorCodeManager || {
    errorCodes: {
        ...
        ooeInvalidGetRowColumnCounts: 2010,
...
var OsfRuntime;
(function (OsfRuntime) {
    var BaseWACFacade = (function () {
        function BaseWACFacade(wnd, hostControl) {
            this.wnd = wnd;
            this.hostControl = hostControl;
            var _me = this;
            var dynamicRegisterEventActions = function (payload, params) {
                if (payload["Error"] == 0) {
            ...
            this.executeMethod = function (params, callback) {
                hostControl.invokeDdaMethod(params, function onComplete(payload) {
                    dynamicRegisterEventActions(payload, params);
                    if (callback) {
                        callback(payload);
                    }
                }, null);
        ...
        return BaseWACFacade;
    })();
    OsfRuntime.BaseWACFacade = BaseWACFacade;
    var ThrottledWACFacade = (function (_super) {
        __extends(ThrottledWACFacade, _super);
        function ThrottledWACFacade(wnd, hostControl) {
            _super.call(this, wnd, hostControl);
            if (!hostControl.getThrottleForCall) {
                return;
            }
            var baseExecuteMethod = this.executeMethod;
            this.executeMethod = function (params, callback) {
                var throttle = hostControl.getThrottleForCall(params);
                if (!throttle) {
                    baseExecuteMethod(params, callback);
                    return;
                }
                var throttleStatus = throttle.tryAsyncRequest(function (notifyThrottleOnComplete) {
                    baseExecuteMethod(params, function (payload) {
                        notifyThrottleOnComplete();
                        callback && callback(payload);
                    });
                });
                if (throttleStatus !== OsfRuntime.Throttling.ThrottleRequestStatus.Allowed) {
                    var errorCodeMap = ThrottledWACFacade._throttleStatusToErrorCodeMapping;
                    var errorCode = errorCodeMap.hasOwnProperty(throttleStatus.toString()) ?
                        errorCodeMap[throttleStatus] : OSF.DDA.ErrorCodeManager.errorCodes.ooeInternalError;
                    var errorResult = {};
                    errorResult[OSF.DDA.Marshaling.ApiResponseKeys.Error] = errorCode;
                    callback && callback(errorResult);
                }
            };
        }
        ThrottledWACFacade._getThrottleStatusToErrorCodeMapping = function () {
            var throttleStatusToErrorCodeMapping = {};
            throttleStatusToErrorCodeMapping[OsfRuntime.Throttling.ThrottleRequestStatus.ThrottledRequestTokensUnavailable] = OSF.DDA.ErrorCodeManager.errorCodes.ooeRequestTokenUnavailable;
            throttleStatusToErrorCodeMapping[OsfRuntime.Throttling.ThrottleRequestStatus.ThrottledTooManyIncompleteRequests] = OSF.DDA.ErrorCodeManager.errorCodes.ooeTooManyIncompleteRequests;
            return throttleStatusToErrorCodeMapping;
        };
        ThrottledWACFacade._throttleStatusToErrorCodeMapping = ThrottledWACFacade._getThrottleStatusToErrorCodeMapping();
        return ThrottledWACFacade;
    })(BaseWACFacade);
    OsfRuntime.ThrottledWACFacade = ThrottledWACFacade;
})(OsfRuntime || (OsfRuntime = {}));
var WordWACRuntime;
(function (WordWACRuntime) {
    function _setupFacade(hostControl, contextActivationManager, serviceEndPoint, serviceEndPointInternal) {
        var wordFacade = new OsfRuntime.ThrottledWACFacade(window, hostControl);
        wordFacade.serviceEndpoint = serviceEndPoint;
        ...
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidAddDataPartMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDataPartByIdMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDataPartsByNamespaceMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDataPartXmlMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDataPartNodesMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidDeleteDataPartMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDataNodeValueMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDataNodeXmlMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDataNodesMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidSetDataNodeValueMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidSetDataNodeXmlMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidAddDataNamespaceMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDataUriByPrefixMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDataPrefixByUriMethod] = OSF.OsfControlPermission.ReadDocument;
        ...
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDocumentCopyMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetDocumentCopyChunkMethod] = OSF.OsfControlPermission.ReadDocument;
        ...
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidReleaseBindingMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidAddBindingFromSelectionMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidAddBindingFromNamedItemMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidGetBindingDataMethod] = OSF.OsfControlPermission.ReadDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidSetBindingDataMethod] = OSF.OsfControlPermission.WriteDocument;
        ...
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidAddRowsMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidAddColumnsMethod] = OSF.OsfControlPermission.WriteDocument;
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidClearAllRowsMethod] = OSF.OsfControlPermission.WriteDocument;
        ...
        serviceEndPoint.registerMethod("executeMethod", wordFacade.executeMethod, Microsoft.Office.Common.InvokeType.async, false);
        serviceEndPoint.registerEventEx("documentSelectionChanged", wordFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, wordFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerEventEx("bindingSelectionChanged", wordFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, wordFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerEventEx("settingsChanged", wordFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, wordFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        ...
        serviceEndPoint.registerEventEx("dialogMessageReceived", wordFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, wordFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        ...
        contextActivationManager._hostType = OSF.HostType.Word;
        contextActivationManager._hostPlatform = OSF.HostPlatform.Web;
        contextActivationManager._hostSpecificFileVersion = OSF.HostSpecificFileVersionMap["word"]["web"];
        if (!contextActivationManager._spBaseUrl && contextActivationManager._enableMyOrg && contextActivationManager._docUrl) {
            var items = contextActivationManager._docUrl.split('/');
            contextActivationManager._spBaseUrl = items.length > 2 ? items[0] + '//' + items[2] : null;
        }
        var supportedCapabilities = [OSF.Capability.Document];
        var supportedHosts = [OSF.Capability.Document];
        var supportedSets = [{
                ...
                name: OSF.RequirementSetNames.ImageCoercion
            }, {
                name: OSF.RequirementSetNames.MatrixCoercion
            }, {
                name: OSF.RequirementSetNames.OoxmlCoercion
            }, {
                name: OSF.RequirementSetNames.PdfFile
            }, {
                ...
                name: OSF.RequirementSetNames.TextFile
            }, {
                name: OSF.RequirementSetNames.WordApi,
                maxVersion: "1.2"
            }];
        ...
        var supportedMethods = [
            ...
            methods["Binding.getDataAsync"],
            methods["Binding.setDataAsync"],
            methods["CustomXmlParts.addAync"],
            methods["CustomXmlParts.getByIdAsync"],
            methods["CustomXmlParts.getByNamespaceAsync"],
            methods["CustomXmlPart.getXmlAsync"],
            methods["CustomXmlPart.getNodesAsync"],
            methods["CustomXmlPart.deleteAsync"],
            methods["CustomXmlNode.getNodesAsync"],
            methods["CustomXmlNode.getNodeValueAsync"],
            methods["CustomXmlNode.getXmlAsync"],
            methods["CustomXmlNode.setNodeValueAsync"],
            methods["CustomXmlNode.setXmlAsync"],
            methods["CustomXmlPrefixMappings.addNamespaceAsync"],
            methods["CustomXmlPrefixMappings.getNamespaceAsync"],
            methods["CustomXmlPrefixMappings.getPrefixAsync"],
    ...
    WordWACRuntime._setupFacade = _setupFacade;
    ;
})(WordWACRuntime || (WordWACRuntime = {}));
OSF.AppSpecificSetup._setupFacade = WordWACRuntime._setupFacade;

...
var FilePickerStyleHelper;
(function (FilePickerStyleHelper) {
    var classN = "class";
    var htmlDir;
    var DefaultDPI = 96;
    (function (NodeType) {
    ...
    })(FilePickerStyleHelper.NodeType || (FilePickerStyleHelper.NodeType = {}));
    var NodeType = FilePickerStyleHelper.NodeType;
    ...
    FilePickerStyleHelper.addClass = addClass;
    function dpiScaleHeightAndWidth(element) {
        dpiScaleHeight(element);
        dpiScaleWidth(element);
    }
    FilePickerStyleHelper.dpiScaleHeightAndWidth = dpiScaleHeightAndWidth;
    function dpiScaleHeight(element) {
        var newHeight = element.offsetHeight * getDPIScaleYRatio();
        element.style.height = newHeight + "px";
    }
    FilePickerStyleHelper.dpiScaleHeight = dpiScaleHeight;
    function dpiScaleWidth(element) {
        var newWidth = element.offsetWidth * getDPIScaleXRatio();
        element.style.width = newWidth + "px";
    }
    FilePickerStyleHelper.dpiScaleWidth = dpiScaleWidth;
    function getDPIScaleXRatio() {
        return (window.screen.logicalXDPI ? window.screen.logicalXDPI : DefaultDPI) / DefaultDPI;
    }
    function getDPIScaleYRatio() {
        return (window.screen.logicalYDPI ? window.screen.logicalYDPI : DefaultDPI) / DefaultDPI;
    }
    function getDocumentHeight() {
        return getDocumentDimension("Height");
    }
    FilePickerStyleHelper.getDocumentHeight = getDocumentHeight;
    function getDocumentWidth() {
        return getDocumentDimension("Width");
    }
    FilePickerStyleHelper.getDocumentWidth = getDocumentWidth;
    ...
    function setHtmlEncodedText(element, text) {
        ...
        for (var j = 0; j < childrenCount; j++) {
            if (childNodes[j].nodeType === NodeType.TEXT) {
    ...
    FilePickerStyleHelper.setHtmlEncodedText = setHtmlEncodedText;
    ...
    FilePickerStyleHelper.removeClass = removeClass;
    function hasClass(elmt, clsName) {
        var className = elmt.getAttribute(classN);
        return className && className.match(new RegExp('(\\s|^)' + clsName + '(\\s|$)'));
    }
    FilePickerStyleHelper.hasClass = hasClass;
})(FilePickerStyleHelper || (FilePickerStyleHelper = {}));
var OneNoteFilePickerHelper;
(function (OneNoteFilePickerHelper) {
    var ModalDialog = (function () {
        function ModalDialog(installOsfControl, cancelUpload, containerDiv) {
            ...
            this.installOsfControl = installOsfControl;
            this.cancelUpload = cancelUpload;
            this.containerDiv = containerDiv;
            this.overlayDiv = document.createElement("div");
            FilePickerStyleHelper.addClass(this.overlayDiv, "Overlay");
            this.containerDiv.appendChild(this.overlayDiv);
            this.dialogDiv = document.createElement("div");
            this.dialogDiv.setAttribute("role", "dialog");
            FilePickerStyleHelper.addClass(this.dialogDiv, "ConfirmDialog");
        ...
        ModalDialog.prototype.init = function () {
            ...
            FilePickerStyleHelper.addClass(this.browseButton, "WACButton");
        ...
        ModalDialog.prototype.hideDialog = function () {
            ...
            this.containerDiv.removeChild(this.dialogDiv);
            this.containerDiv.removeChild(this.overlayDiv);
        };
        ModalDialog.prototype.showDialog = function (buttonsCreationInfo) {
            ...
            for (var i = 0; i < buttonsCreationInfo.length; i++) {
                ...
                FilePickerStyleHelper.addClass(button, "WACButton WACDialogButtonNormal");
                button.onclick = buttonInfo.onclick;
                this.buttonDiv.appendChild(button);
                this.buttonElements.push(button);
                FilePickerStyleHelper.dpiScaleHeightAndWidth(button);
        ...
        ModalDialog.prototype.positionDialog = function () {
            ...
            var top = FilePickerStyleHelper.getDocumentHeight() / 2 - uploadDialog.offsetHeight / 2;
            var left = FilePickerStyleHelper.getDocumentWidth() / 2 - uploadDialog.offsetWidth / 2;
            ...
            if (resultFile != null) {
                ...
                if ((fileType != "text/xml" && fileType != "application/xml") || fileSize > fileSizeMax) {
                    ...
                    this.reader.onload = function () {
                        ...
                        _this.installOsfControl(params, null);
                    };
                }
            }
            if (resultFile == null) {
    ...
    OneNoteFilePickerHelper.ModalDialog = ModalDialog;
    var MenuHandler = (function () {
        function MenuHandler(containerDiv, uploadDialog) {
            ...
            this.hideMenu();
            this.menuDiv.id = "ManageAddinMenu";
            FilePickerStyleHelper.addClass(this.menuDiv, "HostSpecificBorderColor");
        }
    ...
    OneNoteFilePickerHelper.MenuHandler = MenuHandler;
    var OptionsMenuItem = (function () {
        function OptionsMenuItem(menuDiv, id, text, title) {
            ...
            FilePickerStyleHelper.setHtmlEncodedText(this.element, text);
            this.element.setAttribute("title", title);
            this.element.setAttribute("tabindex", "0");
            this.element.setAttribute("role", "menuitem");
            this.element.id = id;
            FilePickerStyleHelper.addClass(this.element, "menuOption");
        ...
        OptionsMenuItem.prototype.setDisabled = function (disabled) {
            ...
            if (disabled) {
                FilePickerStyleHelper.addClass(this.element, "disabled");
            }
            else {
                FilePickerStyleHelper.removeClass(this.element, "disabled");
            }
        };
        return OptionsMenuItem;
    })();
    OneNoteFilePickerHelper.OptionsMenuItem = OptionsMenuItem;
})(OneNoteFilePickerHelper || (OneNoteFilePickerHelper = {}));
var OsfRuntime;
(function (OsfRuntime) {
...
(function (OneNoteWACRuntime) {
    function _setupFacade(hostControl, contextActivationManager, serviceEndPoint, serviceEndPointInternal) {
        ...
        serviceEndPoint.registerEventEx("dialogMessageReceived", onenoteFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, onenoteFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerEventEx("dialogParentMessageReceived", onenoteFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, onenoteFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        ...
        contextActivationManager._cancelUploadAction = 1231;
        contextActivationManager._onCancelUpload = function (params, callback) {
            contextActivationManager._notifyHost("0", contextActivationManager._cancelUploadAction, params);
        };
        contextActivationManager.insertAddinWithManifest = function (manifestUrl) {
            var processManifestFile = function OSF_ContextActivationManager_insertAddinWithManifest$processManifestFile(manifestString, urlInputElement) {
                var parsedManifest = new OSF.Manifest.Manifest(manifestString, contextActivationManager.getAppUILocale());
                if (!OSF.OsfManifestManager.hasManifest(parsedManifest.getMarketplaceID(), parsedManifest.getMarketplaceVersion())) {
                    OSF.OsfManifestManager.cacheManifest(parsedManifest.getMarketplaceID(), parsedManifest.getMarketplaceVersion(), parsedManifest);
                }
                var params = {
                    ...
                    "storeId": "developer",
                    "assetId": parsedManifest.getMarketplaceID(),
                    "assetStoreId": OSF.StoreType.HardCodedPreinstall,
                    "width": parsedManifest.getDefaultWidth() || 0,
                    "height": parsedManifest.getDefaultHeight() || 0,
                    "isAddinCommands": parsedManifest._isAddinCommandsManifest(OSF.getManifestHostType(contextActivationManager._hostType))
                };
                Telemetry.UploadFileDevCatalogUsageHelper.LogUploadFileDevCatalogUsageAction(contextActivationManager._appCorrelationId, params.currentStoreType, params.id, params.appVersion, params.targetType, params.isAddinCommands, params.width, params.height);
                contextActivationManager._notifyHost("0", OSF.AgaveHostAction.InsertAgave, params);
            };
            var onGetManifestError = function OSF_ContextActivationManager_insertAddinWithManifest$onGetManifestError(errorString) {
                Telemetry.RuntimeTelemetryHelper.LogExceptionTag("Error when requesting manifest file: " + errorString, null, contextActivationManager._appCorrelationId, 0x0130b60e);
            };
            OSF.OUtil.xhrGet(manifestUrl, processManifestFile, onGetManifestError);
        };
        contextActivationManager.launchUploadDialog = function OSF_ContextActivationManager$launchUploadDialog(containerDiv) {
            var localeStringLoaded = function () {
                contextActivationManager.launchUploadDialogHelper(containerDiv);
            };
            contextActivationManager._loadWefgalleryLocaleString(Function.createDelegate(this, localeStringLoaded));
        };
        contextActivationManager.launchUploadDialogHelper = function (containerDiv) {
            var uploadDialog = new OneNoteFilePickerHelper.ModalDialog(contextActivationManager._onClickInstallOsfControl, contextActivationManager._onCancelUpload, containerDiv);
            uploadDialog.logUploadFileDevCatelogAction(OSF.UploadFileDevCatelogAction.OpenUploadFileDialog, 0);
            var buttons = [];
            buttons.push({
                id: "DialogInstall",
                text: Strings.wefgallery.L_Upload_Button_Txt,
                hasFocus: true,
                onclick: function () {
                    uploadDialog.logUploadFileDevCatelogAction(OSF.UploadFileDevCatelogAction.Install, 0);
                    uploadDialog.installApp();
            ...
            buttons.push({
                ...
                hasFocus: false,
                onclick: function () {
                    uploadDialog.logUploadFileDevCatelogAction(OSF.UploadFileDevCatelogAction.Cancel, 0);
                    uploadDialog.hideDialog();
                    uploadDialog.cancelUpload(null, null);
                }
            });
            uploadDialog.showDialog(buttons);
        };
        contextActivationManager._loadWefgalleryLocaleString = function OSF_ContextActivationManager$_loadWefgalleryLocaleString(callback) {
            if (typeof Strings == 'undefined' || !Strings || !Strings.wefgallery) {
                this._loadWefgalleryStringScript(callback);
            }
            else {
                callback();
            }
        };
        contextActivationManager._loadWefgalleryStringScript = function OSF_ContextActivationManager$_loadWefgalleryStringScript(callback) {
            var path = this.getLocalizedScriptsUrl();
            path += "wefgallery_strings.debug.js";
            var localeStringFileLoaded = function () {
                if (typeof Strings == 'undefined' || !Strings || !Strings.wefgallery) {
        ...
        var supportedCapabilities = [OSF.Capability.Notebook];
        var supportedHosts = [OSF.Capability.Notebook];
        var supportedSets = [{
                ...
                name: OSF.RequirementSetNames.OneNoteApi,
                maxVersion: "1.1"
            }, {
                name: OSF.RequirementSetNames.DialogAPI,
                maxVersion: "1.2"
            }];
...
//# sourceMappingURL=OsfRuntimeOneNoteWAC.debug.js.map
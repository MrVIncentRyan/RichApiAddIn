...
var OneNoteWACRuntime;
(function (OneNoteWACRuntime) {
    function _setupFacade(hostControl, contextActivationManager, serviceEndPoint, serviceEndPointInternal) {
        var onenoteFacade = new OsfRuntime.ThrottledWACFacade(window, hostControl);
        onenoteFacade.serviceEndpoint = serviceEndPoint;
        ...
        registeredActions.executeMethod[OSF.DDA.MethodDispId.dispidExecuteRichApiRequestMethod] = OSF.OsfControlPermission.WriteDocument;
        ...
        serviceEndPoint.registerMethod("executeMethod", onenoteFacade.executeMethod, Microsoft.Office.Common.InvokeType.async, false);
        serviceEndPoint.registerEventEx("documentSelectionChanged", onenoteFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, onenoteFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        serviceEndPoint.registerEventEx("settingsChanged", onenoteFacade.registerEvent, Microsoft.Office.Common.InvokeType.asyncRegisterEvent, onenoteFacade.unregisterEvent, Microsoft.Office.Common.InvokeType.asyncUnregisterEvent);
        ...
        contextActivationManager._hostType = OSF.HostType.OneNote;
        contextActivationManager._hostPlatform = OSF.HostPlatform.Web;
        contextActivationManager._hostSpecificFileVersion = OSF.HostSpecificFileVersionMap["onenote"]["web"];
        contextActivationManager._allowExternalMarketplace = true;
        contextActivationManager._enableMyOrg = false;
        contextActivationManager._enableMyApps = true;
        ...
        var supportedCapabilities = [OSF.Capability.Notebook, OSF.Capability.Document, OSF.Capability.Presentation, OSF.Capability.Workbook];
        var supportedHosts = [OSF.Capability.Notebook, OSF.Capability.Document, OSF.Capability.Presentation, OSF.Capability.Workbook];
        var supportedSets = [{
    ...
    OneNoteWACRuntime._setupFacade = _setupFacade;
    ;
})(OneNoteWACRuntime || (OneNoteWACRuntime = {}));
OSF.AppSpecificSetup._setupFacade = OneNoteWACRuntime._setupFacade;
